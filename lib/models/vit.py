...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
        ...
        self.head=Mlp(embed_dim,act_layer=nn.GELU,out_features=num_classes) if num_classes >0 else nn.Identity()
...
class TimeSformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, num_classes=400, num_frames=8, attention_type='divided_space_time',  pretrained_model='/home/fengchuang/pytorch-image-models-0.1-vitjx/output/train/20220112-224522-vit_base_patch16_224-224/latest.pth.tar', **kwargs):
        ...
        if self.pretrained:
            # pretrained_model='/home/fengchuang/pytorch-image-models-0.1-vitjx/output/train/20220112-224522-vit_base_patch16_224-224/latest.pth.tar'
